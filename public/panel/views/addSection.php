...
<div class="form position-relative top-pad">
	<?php
		...
		if($pid!=="" && $page!=="")
		{
			...
			{
				define("SECTION_LINK", "?addSection&pid=".$pid."&page=".$page);

				if( isset($_POST["add"]) )
				{
					$entityId = createEntity($pid, 0);
					if($entityId!==false)
					{
					...
					<section id="welcome" class="tm-section tabs-wrapper">
						<form action="<?php echo SECTION_LINK ?>" method="post" class="contact-form" enctype="multipart/form-data">
							<div class="top-section-funktional">
								<a  href='<?php echo $_SERVER["SCRIPT_NAME"]."?sections&pid=".$pid."&page=".$page ?>' class="south-east btn blue"> Back <img src="img/back.png" alt=""></a>
